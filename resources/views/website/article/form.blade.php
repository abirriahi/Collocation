...
<div class="text2{{ $errors->has('art_type') ? ' has-error' : '' }}">
    <div class="col-md-10">
        ...
        <input class="optionDemande" type="radio" name="art_type" value="1"  />  Demande
        <br>
        <input class="optionOffre" type="radio" name="art_type" value="0" checked /> Offre
...
<div class="text2{{ $errors->has('chambres') ? ' has-error' : '' }}">
    <div class="col-md-10">
        <label class="col-md-4 control-label">Nombre de chambres</label>
...
<div class="text2{{ $errors->has('image') ? ' has-error' : '' }}">
    ...
    <div class="col-md-10">
        ...
        <div class="text2{{ $errors->has('art_latitude') ? ' has-error' : '' }}" style="display:none">
            <div class="col-md-6">
        ...
        <div class="text2{{ $errors->has('art_langtuide') ? ' has-error' : '' }}" style="display:none">
            <div class="col-md-6">
    ...
    <div class="form-group">
        <div class="col-md-6">
            <button type="submit" class="btn btn-primary">
                <i class="fa fa-btn fa-save"></i> Envoyer
            </button>
        </div>
    </div>
