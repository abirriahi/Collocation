...
Tous les messages
  ...
  <ol class="breadcrumb">
    <li><a href="{{ url('/adminpanel')}}"><i class="fa fa-dashboard"></i>Aceuil</a></li>
    <li class="active"><a href="{{ url('/adminpanel/contact')}}">Messages</a></li>
...
@section('footer')
  ...
  $('#data thead th').each( function () {
      if($(this).index()  < 2){
          ...
          $(this).html( '<select><option value="0"> nouveau message</option><option value="1"> ancien mesage</option></select>' );
      }
