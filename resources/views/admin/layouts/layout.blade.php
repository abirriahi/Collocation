...
<div class="wrapper" >
  <header class="main-header">
    ...
    <a href="{{URL('/adminpanel')}}" class="logo" >
      ...
      <span class="logo-lg" > <b> {{getSetting()}}</b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            ...
            <ul class="dropdown-menu">
              <li class="header">Vous avez {{ countunreadMessage()}} nouveau(x) message(s)</li>
              <li>
                ...
                <div class="slimScrollDiv"><ul class="menu" >
                    <li>
                      ...
                      <div class="slimScrollDiv" ><ul class="menu">
                          ...
                          <li><!-- Task item -->
                            <a href="{{ url('/adminpanel/contact/'.$valueMesssage->id.'/edit') }}" class="clearfix">
                              <img src="admin/dist/img/user-image.png" class="user-image" alt="User Image" style="width: 30px; height: 30px;">
												<span class="msg-body">
													<span class="msg-title">
														<span class="blue"> {{ $valueMesssage->contact_name }}:</span>
                                                      {{ $valueMesssage->created_at->format('Y-m-d') }}
													</span>
												</span>
                            </a>
                          </li><!-- end task item -->
              ...
              <li class="footer"><a href="{{url('/adminpanel/contact')}}">Voir tous les messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-danger">{{ countAllBuAppendTostatus(0) }}</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">vous avez {{ countAllBuAppendTostatus(0) }} annonce(s) non-valide(s).</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <div class="slimScrollDiv" ><ul class="menu">
                    <li><!-- Task item -->
                      @foreach(getNotActiveBu() as $buWatting)
                      <a href="{{ url('/adminpanel/articles/'.$buWatting->id.'/edit') }}">
                          {{ $buWatting->art_nom}}
                          <small class="pull-right"><a href="{{url('/adminpanel/change_status/'.$buWatting->id.'/1')}}" >valider </a> </small>
                      </a>
                      @endforeach
                    </li><!-- end task item -->
              ...
              <li class="footer">
                <a href="{{url('/adminpanel/articles')}}">Voir toutes les annonces</a>
              </li>
            </ul>
          </li>
          ...
          <!-- User Account: style can be found in dropdown.less --><li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="height: 100px;">
                <p>
                  {{Auth::user()->name}}
                  <small>Member depuis {{Auth::user()->created_at}}</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- Menu Footer-->
  ...
  <footer class="main-footer">
    ...
    <strong> Admin Panel de site  {{getSetting()}} par RIAHI ABIR.</strong>
...
{!! Html::script('admin/plugins/jQueryUI/jquery-ui.js') !!}
        <!-- jQuery UI 1.11.4 -->
...
@include('admin/layouts/messageDelete')
@yield('footer')
